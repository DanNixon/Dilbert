		...
		bool handleButton(IButton *button){
			...
			if(!button->isActive()){//button released
				if(button->lastActiveDuration() < 800){//short press
					...
					currPattern=currPattern>=PATTERN_COUNT?PATTERN_COUNT-1:
